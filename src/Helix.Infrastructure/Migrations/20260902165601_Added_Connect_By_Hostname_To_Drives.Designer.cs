...
namespace Helix.Infrastructure.Migrations
{
    ...
    [Migration("20260902165601_Added_Connect_By_Hostname_To_Drives")]
    partial class Added_Connect_By_Hostname_To_Drives
    {
            ...
            modelBuilder.Entity("Helix.Domain.Drives.Drive", b =>
                {
                    ...
                    b.Property<bool>("ConnectByHostname")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Helix.Domain.Settings.Settings", b =>
                {
                    ...
                    b.Property<bool>("NotifyOnMinimizeToTray")
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<int>("StorageAlertThresholdPercent")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Helix.Domain.Settings.Settings", b =>
                {
                    b.HasOne("Helix.Domain.Users.User", null)
                        .WithOne()
                        .HasForeignKey("Helix.Domain.Settings.Settings", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
